                        ...
                        <div class="card-body">
                            <form @submit.prevent="onFormSubmitRegister">
                                ...
                                >
                                    <!-- Alias -->
                                    <div
                                        class="d-flex input-full align-items-center flex-column"
                                    >
                                        <InputText
                                    ...
                                    <!-- Buttons -->
                                    <div
                                        class="d-flex w-100 gap-4 mt-4 justify-content-center"
                                    >
                                        <router-link
                                            to="/"
