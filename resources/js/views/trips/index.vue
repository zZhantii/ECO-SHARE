<template>
    ...
    <div
        class="container container-responsive d-flex justify-content-between my-5"
    >
        <div class="row w-aside">
            <div class="col-12 col-md-4">
                ...
                <div
                    class="flex align-items-center gap-2 justify-content-between inputFilter"
                >
                    <Checkbox v-model="filters.earlyDeparture" binary />
                    <label for="earlyDeparture" class="w-75 cursor-pointer"
                        >Salida más temprano</label
                    >
                    <svg
                ...
                >
                    ...
                    <label for="lateDeparture" class="w-75"
                        >Salida más tarde</label
                    >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="32"
                ...
                >
                    ...
                    <label for="lowestPrice" class="w-75">
                        Precio más bajo
                    </label>
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                ...
                >
                    ...
                    <label for="highestPrice" class="w-75">
                        Precio más alto
                    </label>
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                ...
                >
                    ...
                    <label for="highestRating" class="w-75">
                        Valoracion más alto
                    </label>
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                ...
                >
                    ...
                    <label for="lowestRating" class="w-75">
                        Valoracion más bajo
                    </label>
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="row w-main">
            ...
            <div v-else>
                ...
                <div
                    v-else
                    v-for="(trip, index) in displayResults"
                    :key="index"
                    class="col-12 mb-4"
                >
                                ...
                                >
                                    ...
                                    <router-link
                                        :to="{
                                            ...
                                            params: {
                                                id: trip.id,
                                                seats: searchTrip2.available_seats,
                                            },
                                        }"
...
const { getTrips, tripsList, searchTrip, searchTripList, getTagTrips, tags } =
    useTrips();
...
const handleSearch = async (searchData) => {
    try {
        ...
        searchTrip2.value = {
            ...
            locality_start: searchData.origin.address_components.find((comp) =>
...
const applyFilters = () => {
    if (
        ...
        console.log(
            "Sin filtros activos, mostrando todos los resultados:",
    ...
    if (filters.value.availableSeats) {
        orderedResults.sort(
            (a, b) =>
                parseFloat(b.available_seats || 0) -
                parseFloat(a.available_seats || 0)
        );
