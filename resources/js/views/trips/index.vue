        ...
        <div class="row w-aside ">
            <div class="col-12 col-md-4">
                ...
                <div class="flex align-items-center gap-2 justify-content-between inputFilter">
                    <Checkbox v-model="filters.earlyDeparture" inputId="earlyDeparture" name="earlyDeparture" />
                ...
                <div class="flex align-items-center gap-2 justify-content-between inputFilter">
                    <Checkbox v-model="filters.lateDeparture" inputId="lateDeparture" name="lateDeparture" />
                ...
                <div class="flex align-items-center gap-2 justify-content-between inputFilter">
                    <Checkbox v-model="filters.pickupPoint" inputId="pickupPoint" name="pickupPoint" />
                ...
                <div class="flex align-items-center gap-2 justify-content-between inputFilter">
                    <Checkbox v-model="filters.destinationPoint" inputId="destinationPoint" name="destinationPoint" />
                ...
                <div class="flex align-items-center gap-2 justify-content-between inputFilter">
                    <Checkbox v-model="filters.lowestPrice" inputId="lowestPrice" name="lowestPrice" />
                ...
                <div class="flex align-items-center gap-2 justify-content-between inputFilter">
                    <Checkbox v-model="filters.highestPrice" inputId="highestPrice" name="highestPrice" />
...
const filteredTrips = computed(() => {
    return trips.value.filter(trip => {
        if (filters.value.earlyDeparture && trip.time >= "12:00") return false;
        if (filters.value.lateDeparture && trip.time < "12:00") return false;
        if (filters.value.fullTrips && !trip.isFull) return false;
        return true;
    });
});
