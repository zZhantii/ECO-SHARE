        ...
        <section class="faq-section">
            <div class="container">
                ...
                <Accordion :activeIndex="0">
                    ...
                    <AccordionTab header="¿Cómo publicar un viaje?">
                        <p>Publicar un viaje es sencillo:</p>
                        <ol>
                    ...
                    <AccordionTab header="¿Cómo funciona el sistema de pagos?">
